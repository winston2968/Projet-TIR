...
for enterprises but also for personal use, especially as home assistant. 
...
This document details the today used models and systems for classifier 
explanation.
...
We start by presenting a theoretical approach with Abductive Explanation methods. This section tries to formalize a classifier's reasoning to provide a formal  guaranty of the produced explanation. Then, we present methods based on Shapley values that assign an importance value to each input feature of a decision, based on game theory principles. Finally, we develop perturbation methods with LIME and Anchor systems. We present the theoretical aspects of these methods and
their ameliorations.
