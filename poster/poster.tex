...
\huge Toulouse III University, France\\ % University/organization
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\color{DarkSlateGray}\Large \textbf{Contact Information:}\\
\texttt{noe.mastrorillo@univ-toulouse.fr}\\
\texttt{axel.pigeon@univ-toulouse.fr}\\
\texttt{antoine.sinatti@univ-toulouse.fr}\\
\texttt{matthias.tortosa@univ-toulouse.fr}\\
\end{minipage}
%
